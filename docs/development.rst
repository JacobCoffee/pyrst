...
- **uv**: Python package manager (`installation guide <https://github.com/astral-sh/uv>`_)
...
See `CONTRIBUTING.md <../CONTRIBUTING.md>`_ for:
...
- **Issues**: `GitHub Issues <https://github.com/JacobCoffee/pyrst/issues>`_
- **Discussions**: `GitHub Discussions <https://github.com/JacobCoffee/pyrst/discussions>`_
- **Email**: jacob@z7x.org
